...
```{r}
two_way_analysis_order(two_way_data_METI, 1, title = 'METI')
```
...
```{r}
two_way_analysis_order(two_way_data_Expertise, 1, title = 'Expertise')
