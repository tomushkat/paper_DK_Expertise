...
```{r}
two_way_analysis_gap(Data_3$idk_minus_know_meti)
...
```{r}
two_way_analysis_gap(Data_3$idk_minus_know_Expertise)
...
## third way interaction
```{r}
two_way_analysis_gap(Data_3$idk_minus_know_Integrity)
...
## third way interaction
```{r}
two_way_analysis_gap(Data_3$idk_minus_know_Benevolance)
